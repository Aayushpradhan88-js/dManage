        ...
        <div>
            ...
            < aside className="w-64 bg-white shadow-md" >
                ...
                <nav className="mt-5 px-2">
                    ...
                    {/* Stats */}
                    <Link href="/institute/dashboard/stats" className="mt-1 group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                        <svg className="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="mt-auto p-4 border-t">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            <p className="text-sm font-medium text-gray-700">View Institute</p>
                            <p className="text-xs font-medium text-gray-500">Aayush Pradhan</p>
                        </div>
                    </div>
                </div>
            </aside >
