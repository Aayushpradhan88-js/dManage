...
function CategoryPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* add category */}
      <button onClick={openModal} className="bg-green-400 h-8.5 p-2 rounded pb-1">+ Category</button>
                ...
                <tr key={category.id} className="bg-white duration-500 hover:bg-gray-50">
                  ...
                  <td className=" p-5 ">
                    <div className="flex items-center gap-1">
                      ...
                      {/* edit */}
                      <button className="cursor-pointer p-2 rounded-full  group transition-all duration-500  flex item-center">
                      ...
                      {isDeleteModalOpen && <DeletePopupModal deletCloseModal={deleteCloseModal} categoryId={category?.id} />}
                      {/* delete */}
                      <button
                        onClick={() => handleCategoryDelete(category?.id, category?.categoryName)}
                        className="cursor-pointer p-2 rounded-full group transition-all duration-500  flex item-center">
